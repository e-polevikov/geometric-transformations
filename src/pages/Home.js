...
export function Home() {
  return (
    <div className={styles['homepage']}>
      ...
      <p>В примере выше параллельный перенос фигуры выполнен с помощью двух преобразований — осевых симметрий относительной прямой DE.</p>

      <h3>Формулировка задачи</h3>

      <p>Участнику доступны два типа преобразований — осевая симметрия и поворот на угол относительно точки (по часовой стрелке и против часовой стрелки). Задача участника — построить требуемую конфигурацию фигур, заданных на плоскости, используя эти два типа преобразований. Для 1-го уровня необходимо получить прямоугольник. Для 2-го и 3-го уровней — квадрат. Ниже приведены примеры ожидаемых результатов для каждого уровня.</p>
      ...
      <ul>
        <li>Приведенные в примерах выше конфигурации не являются единственными возможными решениями. Участник может располагать фигуры на плоскости произвольно. Важно лишь, чтобы объединение фигур давало требуемый результат.</li>
        <li>Преобразования, в результате которых фигура полностью оказывается за пределами плоскости, не допускаются. Фигура может частично выходить за пределы плоскости, но необходимо, чтобы хотя бы одна из вершин фигур была внутри плоскости.</li>
      </ul>
